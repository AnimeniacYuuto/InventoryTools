...
public class CompChestDollyBlockHandler implements IDollyBlockHandler{

	protected static CompChestDollyBlockHandler instance=null;
	public static final CompChestDollyBlockHandler getInstance(){
		if(instance==null)
			instance=new CompChestDollyBlockHandler();
		return instance;
	}
	
	private CompChestDollyBlockHandler(){}
	
	
	@Override
	public String getID() {
		// TODO Auto-generated method stub
		return "blockhandler.compactstorage.compactchest";
	}
