...
public class JabbaBarrelBlockHandler implements IDollyBlockHandler{

	protected static JabbaBarrelBlockHandler instance=null;
	public static final JabbaBarrelBlockHandler getInstance(){
		if(instance==null)
			instance=new JabbaBarrelBlockHandler();
		return instance;
	}
	
	private JabbaBarrelBlockHandler(){}
	
	
	@Override
	public String getID() {
		// TODO Auto-generated method stub
		return "blockhandler.jabba.betterbarrel";
	}
